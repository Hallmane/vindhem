...
<header class="masthead" id="top"><div class="running-head"><span>Specification / ${escape(contract.info.version)}${contract.info.version.startsWith('0.') ? ' · Development release' : ''}</span></div><div class="title-spread"><h1>Vindhem</h1><div class="edition">OpenAPI ${escape(contract.openapi)} · JSON Schema</div></div>
